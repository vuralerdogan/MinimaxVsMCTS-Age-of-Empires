 ...
 * @author Lydia
 */
public class EmpiresAge2  extends SwingWorker <List<HashMap>, HashMap> {
    ...
    public void getUI2(gameGUI gg)
    {
        this.gg = gg;
    }
    
    public void choseUI2(gameGUI gg)
    {
        this.gg = gg;
    }
