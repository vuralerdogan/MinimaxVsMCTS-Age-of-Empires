 ...
 * @author Lydia
 */
public class EmpiresAge1  extends SwingWorker <List<HashMap>, HashMap> {
    ...
    public void serialSet(gameGUI gg)
    {
        this.gg = gg;
    } 
  ...
  String s ="";
    ...
    public void runGameMCTSvsMonteCarlo() throws IOException, InterruptedException
    {   
        for ( x=0;x<3;x++){
        ...
        if(mc.endGame(gameState)){
         ...
         public void runGameMonteCarlovsMonteCarlo() throws IOException, InterruptedException {
    ...
    public void runGameMinmaxvsMCTS() throws IOException, InterruptedException
    {   for ( x=0;x<3;x++){
        long then = System.currentTimeMillis();
    ...
    public void runGameMCTSvsMCTS() throws IOException, InterruptedException
    {   for ( x=0;x<3;x++){
        long then = System.currentTimeMillis();
        //HashMap <String,Integer> state2 = (HashMap) state.clone();
        //HashMap <String,Integer> state3 = (HashMap) state.clone();
    ...
    public void runGameMinmaxvsMonteCarlo() throws IOException, InterruptedException
    {       for ( x=0;x<3;x++){
        long then = System.currentTimeMillis();
        //HashMap <String,Integer> state2 = (HashMap) state.clone();
        //HashMap <String,Integer> state3 = (HashMap) state.clone();
    ...
    public void runGameMinimaxvsMinimax() throws IOException, InterruptedException
    {           for ( x=0;x<3;x++){
        long then = System.currentTimeMillis();
        //HashMap <String,Integer> state2 = (HashMap) state.clone();
        //HashMap <String,Integer> state3 = (HashMap) state.clone();
     ...
     * @throws IOException
     */
    public void runGameMCTSvsMinmax() throws IOException, InterruptedException
    {       for ( x=0;x<3;x++){
        long then = System.currentTimeMillis();
        //HashMap <String,Integer> state2 = (HashMap) state.clone();
        //HashMap <String,Integer> state3 = (HashMap) state.clone();
    ...
    public void runGameMonteCarlovsMinmax() throws IOException, InterruptedException
    {       for ( x=0;x<3;x++){
        long then = System.currentTimeMillis();
        //HashMap <String,Integer> state2 = (HashMap) state.clone();
        //HashMap <String,Integer> state3 = (HashMap) state.clone();
    ...
    public void runGameMonteCarlovsMCTS() throws IOException, InterruptedException
    {           for ( x=0;x<3;x++){
        long then = System.currentTimeMillis();
        //HashMap <String,Integer> state2 = (HashMap) state.clone();
        //HashMap <String,Integer> state3 = (HashMap) state.clone();
